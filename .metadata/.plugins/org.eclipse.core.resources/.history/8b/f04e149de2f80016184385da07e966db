...
public class FindLineBack implements Behavior {
	...
	public FindLineBack(LightSensor l1, LightSensor l2, DifferentialPilot pilot, CornerType corner){
		this.pilot = pilot;
		this.l1 = l1;
		this.l2 = l2;
		this.corner = corner;
	...
	public void action() {
        ...
        while (!suppressed && this.corner.timesincelineseen > 4000) {
	    	...
	    	LCD.drawString("Keeping Looking", 0, 3);
        }
	}
}
